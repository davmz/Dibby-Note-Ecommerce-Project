...
ActiveRecord::Schema[7.0].define(version: 2022_04_26_074516) do
  ...
  create_table "carts", force: :cascade do |t|
    ...
    t.integer "instrument_cart_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["instrument_cart_id"], name: "index_carts_on_instrument_cart_id"
  ...
  add_foreign_key "carts", "instrument_carts"
